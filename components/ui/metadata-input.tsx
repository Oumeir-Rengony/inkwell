  ...
  return (
    ...
    <AlertDialog open={publishModal} onOpenChange={setPublishModal}>
      ...
      <DialogModal
        ...
        variants={{ yes: isPublished ? "destructive" :  "secondary" }}
        onAcceptAction={isPublished ? onUnpublish : onPublish}
          ...
          {isPublished ? (
            <>
              ...
              <AlertDialogTrigger asChild>
                <button className="flex items-center justify-center gap-2 bg-transparent border border-[#E8EDE9] p-3 rounded-full text-sm font-medium cursor-pointer">
            ...
            <AlertDialogTrigger asChild>
              <button className="flex items-center justify-center gap-2 bg-[#1E3530] text-[#FAF5E8] p-3 font-semibold rounded-full cursor-pointer border-0">
                <Globe size={14} />
                Publish Article
              </button>
            </AlertDialogTrigger>
